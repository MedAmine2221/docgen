...
const NAV_ITEMS = [
  { label: "Gérer les users", path: "/admin/users",    icon: <IconUsers /> },
  { label: "Gérer les docs",  path: "/admin/docs",     icon: <IconDocs />  },
  { label: "Gérer les APIs",  path: "/admin/apis",     icon: <IconApi />   },
];
  ...
  return (
    <div className="flex h-screen bg-neutral-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Topbar */}
        <header className="h-14 bg-white border-b border-neutral-100 px-6 flex items-center justify-between flex-shrink-0">
